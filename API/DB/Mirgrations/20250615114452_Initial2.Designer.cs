...
namespace API.DB.Mirgrations
{
    ...
    [Migration("20250615114452_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("API.Data.Models.BookingDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "BookingId", "SeatId" }, "UK_BookingDetails_Booking_Seat")
                        .IsUnique();

                    b.ToTable("BookingDetails");
                });

            modelBuilder.Entity("API.Data.Models.Concession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.ConcessionCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.ConcessionOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.ConcessionOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "ConcessionOrderId", "ConcessionId" }, "UK_ConcessionOrderDetails_Order_Concession")
                        .IsUnique();

                    b.ToTable("ConcessionOrderDetails");
                });

            modelBuilder.Entity("API.Data.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.MovieGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.Seat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.SeatType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.ShowTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.Theater", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.Models.Booking", b =>
                {
                    b.HasOne("API.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Bookings")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Data.Models.ShowTime", "ShowTime")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("API.Data.Models.BookingDetail", b =>
                {
                    b.HasOne("API.Data.Models.Booking", "Booking")
                    ...
                    b.HasOne("API.Data.Models.Seat", "Seat")
                        .WithMany("BookingDetails")
            ...
            modelBuilder.Entity("API.Data.Models.Concession", b =>
                {
                    b.HasOne("API.Data.Models.ConcessionCategory", "Category")
            ...
            modelBuilder.Entity("API.Data.Models.ConcessionOrderDetail", b =>
                {
                    b.HasOne("API.Data.Models.Concession", "Concession")
                    ...
                    b.HasOne("API.Data.Models.ConcessionOrder", "ConcessionOrder")
                        .WithMany("ConcessionOrderDetails")
            ...
            modelBuilder.Entity("API.Data.Models.MovieGenre", b =>
                {
                    b.HasOne("API.Data.Models.Genre", "Genre")
                        .WithMany("MovieGenres")
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Data.Models.Movie", "Movie")
                        .WithMany("MovieGenres")
            ...
            modelBuilder.Entity("API.Data.Models.Payment", b =>
                {
                    b.HasOne("API.Data.Models.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("API.Data.Models.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("API.Data.Models.Screen", b =>
                {
                    b.HasOne("API.Data.Models.Theater", "Theater")
                        .WithMany("Screens")
            ...
            modelBuilder.Entity("API.Data.Models.Seat", b =>
                {
                    b.HasOne("API.Data.Models.Screen", "Screen")
                        .WithMany("Seats")
                    ...
                    b.HasOne("API.Data.Models.SeatType", "SeatType")
                        .WithMany("Seats")
            ...
            modelBuilder.Entity("API.Data.Models.Theater", b =>
                {
                    b.HasOne("API.Data.Models.Province", "Province")
                        .WithMany("Theaters")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("API.Data.Models.ApplicationUser", null)
                        .WithMany()
